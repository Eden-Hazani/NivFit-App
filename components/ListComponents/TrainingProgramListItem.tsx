...
import { DifficultyLevelIcon } from '../DifficultyLevelIcon';
const { width, height } = Dimensions.get('screen');


export class TrainingProgramListItem extends Component<any>{
    render() {
        return (
                ...
                <TouchableOpacity onPress={this.props.onPress} >
                    <View style={{
                        ...
                        <LinearGradient colors={['rgba(255,255,255,1)', 'rgba(255,255,255,0)']} start={[0, 1]} end={[.6, 0]} style={{ zIndex: 10, position: 'absolute', left: 10, padding: 15, paddingRight: 200, borderRadius: 15 }}>
                            ...
                            <DifficultyLevelIcon difficulty={this.props.difficulty} animationX={-200} animationY={0} />
                        </LinearGradient>
                        <Image style={{
                            zIndex: -10,
